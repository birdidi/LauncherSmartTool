...
public class LayoutProfileSamsung {
    ...
    public static List<CellBean> layout() {
        ...
        list.add(CellBean.build(0, 0, 0, 3, CellBean.TYPE_APP, "相机", CellBean.CANDIDATENAME_CAMERA));
        list.add(CellBean.build(0, 0, 1, 3, "视频", CellBean.CANDIDATENAME_VIDEO, RecommandAppPool.TYPE_VIDEO));
        list.add(CellBean.build(0, 0, 2, 3, "音乐", CellBean.CANDIDATENAME_MUSIC, RecommandAppPool.TYPE_MUSIC));
        list.add(CellBean.build(0, 0, 3, 3, CellBean.TYPE_APP, "设置", CellBean.CANDIDATENAME_SETTING));
        list.add(CellBean.build(0, 0, 0, 4, "应用商店", CellBean.CANDIDATENAME_STORE, RecommandAppPool.TYPE_APP_STORE));
        list.add(CellBean.build(0, 0, 1, 4, CellBean.TYPE_APP, "腾讯新闻", RecommandAppPool.TENCENT_NEWS));
        list.add(CellBean.build(0, 0, 2, 4, CellBean.TYPE_APP, "手机管家", RecommandAppPool.TENCENT_SHOUJI));
        list.add(CellBean.build(0, 0, 3, 4, CellBean.TYPE_APP, "高德地图", RecommandAppPool.GAODE));
        ...
        list.add(CellBean.build(0, 1, 1, 1, "阅读", RecommandAppPool.getFuzzyRegexs("阅读"), RecommandAppPool.TYPE_I_READER));
